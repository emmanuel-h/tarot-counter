...
12. **Salon look from the first frame**: a felt-green launcher icon with the three bouts in a brass ring, and a matching splash screen (ivory, or night felt in dark mode) that hands over to the app without a white flash.
...
| Home | Game | Round entry | Game over |
|---|---|---|---|
| ![Home](store/screenshots/en/light/1_home.png) | ![Game](store/screenshots/en/light/2_game.png) | ![Round entry](store/screenshots/en/light/3_round_entry.png) | ![Game over](store/screenshots/en/light/4_game_over.png) |
| ![Home, dark](store/screenshots/en/dark/1_home.png) | ![Game, dark](store/screenshots/en/dark/2_game.png) | ![Round entry, dark](store/screenshots/en/dark/3_round_entry.png) | ![Game over, dark](store/screenshots/en/dark/4_game_over.png) |

French screenshots and the feature graphic live in [`store/`](store/); see [`docs/store-assets.md`](docs/store-assets.md) to regenerate them.
...
│   ├── icon-design.md        # Launcher icon, splash screen, raster generation
│   ├── store-assets.md       # Play Store screenshots and feature graphic
...
- [`docs/store-assets.md`](docs/store-assets.md): Play Store screenshots (generated by an instrumented class) and the feature graphic
- [`docs/icon-design.md`](docs/icon-design.md): launcher icon, splash screen and how the raster icons are generated
