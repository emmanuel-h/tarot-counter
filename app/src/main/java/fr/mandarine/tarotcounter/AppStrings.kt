...
val EnStrings = AppStrings(
    ...
    undoConfirmBody       = "The previous round's data will be pre-filled so you only need to correct what was wrong.",
...
val FrStrings = AppStrings(
    ...
    undoConfirmBody       = "Les données de la manche précédente seront pré-remplies pour que vous ne corrigiez que ce qui était erroné.",
