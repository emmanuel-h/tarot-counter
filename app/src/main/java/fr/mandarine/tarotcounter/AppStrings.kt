...
val EnStrings = AppStrings(
    ...
    undoConfirmBody       = "The last round's results will be removed so you can correct them.",
...
val FrStrings = AppStrings(
    ...
    undoConfirmBody       = "Les résultats de la dernière manche seront supprimés pour que vous puissiez les corriger.",
